...
<body>
    <h1>Welcome, <?php echo htmlspecialchars($_SESSION['username']); ?> to the gourd shop!</h1>

    <h2>Gourds</h2>
    <ul>
        <?php foreach ($products as $product): ?>
            <li>
                <?= htmlspecialchars($product['name']); ?> - <?= htmlspecialchars($product['price']); ?> SC
            ...
            <tbody>
                <?php foreach ($cartItems as $item): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($item['price']); ?> SC</td>
                        <td><?= htmlspecialchars($item['quantity']); ?></td>
                        <td><?= htmlspecialchars(number_format($item['price'] * $item['quantity'], 2)); ?> SC</td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <th><?= htmlspecialchars(number_format($totalPrice, 2)); ?> SC</th>
                    <th></th>
                </tr>
            </tfoot>
        </table>
